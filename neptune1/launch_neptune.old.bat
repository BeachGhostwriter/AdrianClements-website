...
:: Streamlit executable (Windows Store Python 3.13)
set "STREAMLIT=%LOCALAPPDATA%\Packages\PythonSoftwareFoundation.Python.3.13_qbz5n2kfra8p0\LocalCache\local-packages\Python313\Scripts\streamlit.exe"

if not exist "%STREAMLIT%" (
    echo ERROR: streamlit.exe not found.
    echo Run this command to install:
    echo   python -m pip install streamlit plotly pandas numpy openpyxl xlsxwriter
